...
namespace FoenixCore
{
    ...
    {
        public Processor.m68000.CentralProcessingUnit m68000Cpu = null;
        ...
        public FoenixSystem(BoardVersion version, string DefaultKernel)
        {
            ...
            m68000Cpu = new Processor.m68000.CentralProcessingUnit(MemMgr);
        ...
        private void TimerEvent0()
        {
            ...
            if (!m68000Cpu.DebugPause /*-- && !m68000Cpu.Flags.IrqDisable && ((~mask & (byte)Register0.FNX0_INT02_TMR0) == (byte)Register0.FNX0_INT02_TMR0)*/ )
            {
        ...
        private void TimerEvent1()
        {
            ...
            if (!m68000Cpu.DebugPause /*-- && !m68000Cpu.Flags.IrqDisable && ((~mask & (byte)Register0.FNX0_INT03_TMR1) == (byte)Register0.FNX0_INT03_TMR1)*/ )
            {
        ...
        private void TimerEvent2()
        {
            ...
            if (!m68000Cpu.DebugPause /*-- && !m68000Cpu.Flags.IrqDisable && ((~mask & (byte)Register0.FNX0_INT04_TMR2) == (byte)Register0.FNX0_INT04_TMR2)*/ )
            {
