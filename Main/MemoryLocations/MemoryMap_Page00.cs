namespace FoenixCore.MemoryLocations
{
    public static partial class MemoryMap
    {
        ...
        public const int RETURN = 0x000004;         // 4 Bytes Called when the RETURN key is pressed in the immediate mode screen.
                                                    // This will process a command in MONITOR, execute a BASIC command, or
                                                    // add a BASIC program line.
        public const int KEYDOWN = 0x000008;        // 4 Bytes Custom keyboard handler. This defaults to the kernel keypress handler,
                                                    // but you can redirect this to your own routines. Make sure to JML to the original
                                                    // address at the end of your custom routine. Use this to make F-Key macros or custom
                                                    // keyboard commands.
        public const int SCREENBEGIN = 0x00000C;    // 3 Bytes Start of screen in video RAM. This is the upper-left corrner of the current
                                                    // video page being written to. This may not be what's being displayed by VICKY. Update
                                                    // this if you change VICKY's display page.
        public const int COLS_VISIBLE = 0x00000F;   // 2 Bytes Columns visible per screen line. A virtual line can be longer than displayed,
                                                    // up to COLS_PER_LINE long. Default = 80
        ...
        public const int CURSORX = 0x00001A;        // 2 Bytes This is where the blinking cursor sits. Do not edit this direectly.
                                                    // Call LOCATE to update the location and handle moving the cursor correctly.
        public const int CURSORY = 0x00001C;        // 2 Bytes This is where the blinking cursor sits. Do not edit this direectly.
                                                    // Call LOCATE to update the location and handle moving the cursor correctly.
        ...
        public const int STACKBOT = 0x000022;       // 2 Bytes Lowest location the stack should be allowed to write to. If SP falls below
                                                    // this value, the runtime should generate STACK OVERFLOW error and abort.
        public const int STACKTOP = 0x000024;       // 2 Bytes Highest location the stack can occupy. If SP goes above this value, the
                                                    // runtime should generate STACK OVERFLOW error and abort.
        ...
        public const int CPUPC = 0x000200;          // 2 Bytes Debug registers. When BRK is executed, Interrupt service routine will
                                                    // populate this block with the CPU registers.
        ...
        public const int MCMDADDR = 0x000210;       // 3 Bytes Address of the current line of text being processed by the command parser.
                                                    // Can be in display memory or a variable in memory. MONITOR will parse up to MTEXTLEN
                                                    // characters or to a null character.
        ...
        public const int MARG2 = 0x000221;          // 4 Bytes First command argument. May be data or address, depending on command.
                                                    // Data is 32-bit number. Address is 24-bit address and 8-bit length.
        public const int MARG3 = 0x000225;          // 4 Bytes First command argument. May be data or address, depending on command.
                                                    // Data is 32-bit number. Address is 24-bit address and 8-bit length.
        public const int MARG4 = 0x000229;          // 4 Bytes First command argument. May be data or address, depending on command.
                                                    // Data is 32-bit number. Address is 24-bit address and 8-bit length.
        public const int MARG5 = 0x00022D;          // 4 Bytes First command argument. May be data or address, depending on command.
                                                    // Data is 32-bit number. Address is 24-bit address and 8-bit length.
        public const int MARG6 = 0x000231;          // 4 Bytes First command argument. May be data or address, depending on command.
                                                    // Data is 32-bit number. Address is 24-bit address and 8-bit length.
        public const int MARG7 = 0x000235;          // 4 Bytes First command argument. May be data or address, depending on command.
                                                    // Data is 32-bit number. Address is 24-bit address and 8-bit length.
        public const int MARG8 = 0x000239;          // 4 Bytes First command argument. May be data or address, depending on command.
                                                    // Data is 32-bit number. Address is 24-bit address and 8-bit length.
        ...
        public const int LOADFILE_TYPE = 0x00030A;  // 3 Bytes (addr) File type string in loaded data file. Actual string data will be in Bank 1.
                                                    // Valid values are BIN, PRG, P16
        ...
        public const int VECTORS_BEGIN = 0x00FFE0;  // 0 Byte Jumps to ROM READY routine. Modified when alternate command interpreter is loaded.
        public const int JMP_READY = 0x00FFE0;      // 4 Bytes Jumps to ROM READY routine. Modified when alternate command interpreter is loaded.
