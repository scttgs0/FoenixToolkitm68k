...
{
    public class Cpu68000RegisterDisplayControl : Box
    {
...
#pragma warning restore CS0649
        ...
        public Cpu68000RegisterDisplayControl() : this(new Builder("Cpu68000RegisterDisplayControl.ui"))
        {
        ...
        private Cpu68000RegisterDisplayControl(Builder builder) : base(builder.GetRawOwnedObject("Cpu68000RegisterDisplayControl"))
        {
        ...
        private void SetRegisters()
        {
            if (_cpu != null)
            {
                ...
                // ucRegDBR.Register = _cpu.DataBank;
